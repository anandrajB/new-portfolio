...
const Workitems = ({ year, title, duration, details }) => {
    return (
        <ol className='flex flex-col ml-20 md:flex-row relative border-l border-stone-200 text-white' >
            <li className='mb-10 ml-4 '>
                ...
                <p className='my-2 text-base font-normal text-stone-200'>{details}</p>
            </li>
        </ol>
    )
}
